            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                @if (session()->has('error_message'))
                    <div class="flex items-center p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400"
                        ...
                        <div>
                            <span class="font-medium">Coba lagi</span>
                        </div>
                    </div>
                @endif

                <form method="POST" action="{{ url('login') }}" class="space-y-4 md:space-y-6" action="#">
                    @csrf
                    ...
                    <button type="submit"
                        class="w-full text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Masuk</button>
