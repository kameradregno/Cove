    ...
    <div class="mt-14">
        ...
        <div class="flex justify-center items-center min-h-screen pt-10 px-4 md:px-0">
            ...
            <div class="p-4 border-2 border-gray-200 rounded-lg dark:border-gray-700 flex flex-col items-center w-full md:w-full lg:max-w-7xl">
                ...
                <form class="w-full" method="POST" action="{{ url('customer') }}">
                    @csrf
                    <div class="mb-5">
                    ...
                    <div class="mb-5">
                        <label for="order-name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nomer
                    ...
                    <div class="mb-5">
                        <label for="type" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Alamat <span class="text-red-500">*</span></label>
