                    ...
                    <table class="table table-bg-white">
                        ...
                        <tbody>
                            <form method="post" action="{{ url("customer/$customer->id") }}">
                                ...
                                <tr class="">
                                    <td scope="row">
                                        <input type="text" value="{{ $customer->nama }}" class="form-control rounded-2" style="width: 155px;"
                                            name="nama" id="nama" aria-describedby="helpId" placeholder="">
                                    </td>
                                    <td>
                                        <input type="text" value="{{ $customer->telp }}" class="form-control rounded-2" style="width: 155px;"
                                            name="telp" id="telp" aria-describedby="helpId" placeholder="">
                                    </td>
                                    <td>
                                        <input type="text" value="{{ $customer->alamat }}" class="form-control rounded-2" style="width: 155px;"
