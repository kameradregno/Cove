            ...
            <form class="w-full">
                ...
                <div class="flex justify-center">
                    <a href="{{ url("items/$data->id") }}"
                        class="mt-5 text-white bg-blue-500 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Barang Pesanan</a>
                </div>
