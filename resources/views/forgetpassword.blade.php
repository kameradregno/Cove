        ...
        <div
            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form method="POST" action="{{ route('forgetpassword') }}" class="space-y-4 md:space-y-6"
                    ...
                    <button type="submit"
                        class="w-full text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Kirim Kode</button>

                    <p class="text-sm font-light text-center text-gray-500 dark:text-gray-400">
                        Sudah ingat kata sandinya? <a href="{{ url('login') }}"
